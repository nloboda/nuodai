...
all: Fuse FileUtils YdClient FileSystem Main.o
	$(CXX) $(PROD_DEPS) FileSystem/Directory.o Fuse/FuseAdapter.o FileUtils/CryptoLayer.o FileUtils/BlockMapper.o FileUtils/CryptoBlockData.o Configuration/Configuration.o FileUtils/FsBlock.o FileUtils/FileUtils.o YdClient/YandexAuthenticator.o YdClient/YandexDiskClient.o FileUtils/PlainFs.o YdClient/Auth.o Main.o -o a.out -I./FileSystem/h -I./YdClient/h -I./FileUtils/h -I./Fuse/h 
